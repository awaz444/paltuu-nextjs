...
export default function AppDownloadBanner({
    ...
    const card = (
        ...
        >
            ...
            <span
                aria-hidden="true"
                className="absolute inset-x-0 top-0 h-1 bg-primary lg:inset-y-0 lg:right-auto lg:h-auto lg:w-1"
            />
            ...
            <button
                ...
                className="absolute right-2 top-3 rounded-full p-1.5 text-gray-400 transition-colors hover:bg-gray-100 hover:text-gray-700 lg:hidden"
            >
                <X size={16} />
            </button>

            <div className="flex flex-col gap-4 p-4 pt-5 sm:p-5 sm:pt-6 lg:flex-row lg:items-center lg:gap-6 lg:pl-7 lg:pt-5">
                <div className="min-w-0 flex-1">
                    <p className="mb-1 text-[10px] font-bold uppercase tracking-widest text-primary">
                        {promo.eyebrow}
                    </p>
                    <h2 className="pr-8 text-base font-extrabold leading-snug text-gray-900 sm:text-lg lg:pr-0">
                        {promo.title}
                    </h2>
                ...
                <div className="flex shrink-0 flex-wrap items-center gap-3 lg:justify-end lg:flex-nowrap">
                    {promo.deepLink && (
                        <Link
                            href={promo.deepLink}
                    ...
                    <button
                        ...
                        onClick={close}
                        aria-label="Dismiss app promotion"
                        className="hidden rounded-full p-2 text-gray-400 transition-colors hover:bg-gray-100 hover:text-gray-700 lg:block"
                    >
                        <X size={18} />
                    </button>
                </div>
