...
export default function ProchoiceBrandPage() {
  const dispatch = useDispatch<AppDispatch>();
  const { products, loading, error } = useSelector((state: RootState) => state.marketplace);
  const [brandProducts, setBrandProducts] = useState<Product[]>([]);

  const brandName = "Prochoice";
  const displayName = "Prochoice Pet Food Pakistan";
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-4">
                Shop authentic <span className="font-semibold text-gray-900">Prochoice pet food</span> in Pakistan.
                We are your official source for balanced nutrition for cats and dogs, delivering to
      ...
      <div className="bg-white border-t border-gray-200 mt-12 py-12">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">
            Why Choose Prochoice?
          </h2>
          <div className="grid md:grid-cols-2 gap-8 text-gray-600">
            <div>
              <h3 className="font-bold text-gray-900 mb-2">Balanced Nutrition</h3>
              <p className="text-sm leading-relaxed">
                Prochoice provides complete and balanced meals to support your pet's health.
                It's enriched with essential vitamins and minerals.
              </p>
            </div>
            <div>
              <h3 className="font-bold text-gray-900 mb-2">Prochoice Price in Karachi</h3>
              <p className="text-sm leading-relaxed">
                Get the best deals on Prochoice pet food in Karachi.
                We offer prompt delivery of fresh stock to your doorstep.
              </p>
            </div>
          </div>
        </div>
