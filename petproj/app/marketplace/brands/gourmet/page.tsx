...
export default function GourmetBrandPage() {
    const dispatch = useDispatch<AppDispatch>();
    const { products, loading, error } = useSelector((state: RootState) => state.marketplace);
    const [brandProducts, setBrandProducts] = useState<Product[]>([]);

    const brandName = "Gourmet";
    const displayName = "Gourmet Gold Pakistan";
                    ...
                    <div className="flex flex-col md:flex-row gap-8 items-start">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-4">
                                Shop authentic <span className="font-semibold text-gray-900">Gourmet Gold wet cat food</span> in Pakistan.
                                We are your official source for all flavors, delivering to
                        ...
                        <div className="mb-8 flex justify-between items-end border-b border-gray-200 pb-4">
                            <div>
                                ...
                                <p className="text-gray-500 text-sm mt-1">
                                    Browsing {brandProducts.length} premium cat food items
                                </p>
                            </div>
                        </div>
            ...
            <div className="bg-white border-t border-gray-200 mt-12 py-12">
                <div className="max-w-4xl mx-auto px-4">
                    <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">
                        Why Choose Gourmet Cat Food?
                    </h2>
                    <div className="grid md:grid-cols-2 gap-8 text-gray-600">
                        <div>
                            <h3 className="font-bold text-gray-900 mb-2">Exquisite Taste</h3>
                            <p className="text-sm leading-relaxed">
                                Gourmet Gold is crafted for cats with refined palates.
                                Its rich textures and high-quality ingredients make it a favorite for picky eaters.
                            </p>
                        </div>
                        <div>
                            <h3 className="font-bold text-gray-900 mb-2">Gourmet Price in Karachi</h3>
                            <p className="text-sm leading-relaxed">
                                Find the best prices for Gourmet Gold tins and pouches in Karachi.
                                We offer bulk deals and single cans delivered to your door.
                            </p>
                        </div>
                    </div>
                </div>
