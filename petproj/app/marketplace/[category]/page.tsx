...
> = {
  "cat-food": {
    ...
    relatedLinks: [
      ...
      { label: "Adopt a Cat", href: "/browse-pets?species=cat" },
    ],
  },
  ...
  "dog-food": {
    ...
    relatedLinks: [
      ...
      { label: "Adopt a Dog", href: "/browse-pets?species=dog" },
    ],
  },
...
// Only pre-generate the three keyword-targeted categories
...
export async function generateMetadata({
  ...
  if (!config) return { title: "Pet Products | Paltuu.pk" };
  ...
  return {
    ...
    keywords: [
      ...
      `${params.category} pakistan`,
      `buy ${params.category} pakistan`,
      `best ${params.category} pakistan`,
    ...
    openGraph: {
      title: config.title,
      description: config.description,
      url: `https://paltuu.pk/marketplace/${params.category}`,
      type: "website",
    },
    twitter: {
    ...
    alternates: {
      canonical: `https://paltuu.pk/marketplace/${params.category}`,
    },
  };
}
...
export default async function MarketplaceCategoryPage({
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* ── FAQ — structured content for featured snippets & AI citations ─── */}
