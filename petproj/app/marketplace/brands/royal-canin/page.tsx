...
export default function RoyalCaninBrandPage() {
    ...
    const displayName = "Royal Canin";

    useEffect(() => {
        // Fetch products with Royal Canin keyword
            ...
            <div className="bg-white border-b border-gray-200">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-primary font-medium text-lg">royal-canin</p>
                    </div>
                    ...
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            <p className="text-primary font-medium">Breed-specific nutrition</p>
                        </div>
                    </div>
