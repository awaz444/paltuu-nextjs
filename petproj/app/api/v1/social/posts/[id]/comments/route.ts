    ...
    try {
        ...
        const result = await db.query(`
            ...
            SELECT
                ...
                u.social_username,
                u.social_verified     AS author_verified,
...
export async function POST(req: NextRequest, { params }: { params: { id: string } }) {
    try {
        ...
        const commenterRes = await db.query(`SELECT name, profile_image_url, social_username, social_verified FROM users WHERE user_id = $1`, [userId]);
        ...
        emitComment(postId, {
            ...
            author_verified: commenter?.social_verified ?? false,
        }).catch(() => {});
