...
const QurbaniGrid: React.FC<QurbaniGridProps> = ({ animals }) => {
  ...
  const [editingAnimal, setEditingAnimal] = useState<QurbaniAnimal | null>(null);
  const [successMessage, setSuccessMessage] = useState(false);
  const [createModalVisible, setCreateModalVisible] = useState(false);
  

  const handleDelete = async (id: string) => {
    // Here you would dispatch any Redux actions needed
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
      ...
      {animals.map((animal) => (
        ...
        >
          <div className="relative">
            ...
            {animal.approved !== undefined && (
              <div className="absolute top-2 left-2 flex gap-2">
                <div
                  className={`${
                    animal.approved ? "bg-green-600" : "bg-orange-500"
          ...
          <div className="p-4">
            <h3 className="font-bold text-2xl mb-1">{animal.breed}</h3>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                >
                  <Select.Option value="Goat">Goat</Select.Option>
                  <Select.Option value="Cow">Cow</Select.Option>
                  <Select.Option value="Bull">Bull</Select.Option>
                  <Select.Option value="Sheep">Sheep</Select.Option>
                  <Select.Option value="Camel">Camel</Select.Option>
                </Select>
              </div>
            </div>
