...
export default function Login() {
    ...
    return (
        <div className="min-h-screen flex flex-col sm:flex-col lg:flex-row bg-gray-100">
            {/* Left Side - Modified classes */}
            <div className="w-full lg:w-1/2 flex flex-col justify-center items-center bg-primary p-8 text-white rounded-b-3xl lg:rounded-r-3xl lg:rounded-b-none">
                <img
                    src="/paltu_logo.svg"
                    alt="Paltu Logo"
            ...
            {/* Right Side - Modified classes */}
            <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-6 sm:p-12 bg-gray-100">
                <button
