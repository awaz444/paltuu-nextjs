    ...
    <form onSubmit={handleLogin} className="bg-white shadow-lg rounded-2xl p-6">
      ...
      <div className="relative mb-6">
        <input
          ...
          className="w-full border border-gray-300 rounded-xl px-4 pt-5 pb-2 text-sm text-gray-800 focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all"
          placeholder=" "
          required
        />
        <label
      ...
      <div className="relative mb-6">
        ...
        id="password"
          ...
          className="w-full border border-gray-300 rounded-xl px-4 pt-5 pb-2 text-sm text-gray-800 focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all pr-10"
          placeholder=" "
          required
        />
        <label
