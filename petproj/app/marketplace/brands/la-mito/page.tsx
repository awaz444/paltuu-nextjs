...
export default function LaMitoBrandPage() {
    ...
    const displayName = "La Mito";

    useEffect(() => {
        // Fetch products with La Mito keyword
            ...
            <div className="bg-white border-b border-gray-200">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-primary font-medium text-lg">la-mito</p>
                    </div>
                    ...
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            <p className="text-primary font-medium">Natural pet wellness</p>
                        </div>
                    </div>

                    <p className="text-gray-600 text-lg max-w-3xl">
                        La Mito focuses on natural pet wellness solutions with organic ingredients and holistic approaches to pet health. Our products are designed to support your pet's natural vitality and well-being through carefully selected natural components.
                    </p>
                </div>
            </div>
