...
const brands = [
    ...
    },
    {
        name: "La Mito",
        slug: "la-mito",
        image: "/brands/la-mito.png",
        description: "Natural pet wellness",
        longDescription: "La Mito focuses on natural pet wellness solutions with organic ingredients and holistic approaches to pet health. Our products are designed to support your pet's natural vitality and well-being through carefully selected natural components.",
    },
    {
        name: "Pedigree",
        slug: "pedigree",
        image: "/brands/pedigree.png",
        description: "Trusted dog nutrition",
        longDescription: "Pedigree is a globally trusted brand providing complete and balanced nutrition for dogs of all ages and sizes. With decades of research and expertise, Pedigree offers scientifically formulated products that support healthy growth and development.",
    },
    {
        name: "Gourmet",
        slug: "gourmet",
        image: "/brands/gourmet.png",
    ...
    },
    {
        name: "Brit Care",
        slug: "brit-care",
        image: "/brands/brit-care.png",
        description: "Holistic pet nutrition",
        longDescription: "Brit Care provides holistic nutrition solutions with super-premium ingredients and functional supplements. Our products are crafted to support specific health needs and life stages, ensuring optimal nutrition for pets with special dietary requirements.",
    },
    {
        name: "Royal Canin",
        slug: "royal-canin",
        image: "/brands/royal-canin.png",
        description: "Breed-specific nutrition",
        longDescription: "Royal Canin is the leader in breed-specific and health-focused pet nutrition. With precise nutritional formulas tailored to specific breeds, sizes, and health conditions, Royal Canin provides targeted nutrition solutions backed by scientific research.",
    },
    {
        name: "Whiskas",
        slug: "whiskas",
        image: "/brands/whiskas.png",
        description: "Complete cat nutrition",
        longDescription: "Whiskas offers complete and balanced nutrition for cats at every life stage. From kitten to senior, our products provide essential nutrients, vitamins, and minerals to keep cats healthy, happy, and full of life.",
    },
    {
        name: "Fluff'n Bluff",
        slug: "fluff-n-bluff",
        image: "/brands/fluff-n-bluff.png",
        description: "Playful pet accessories",
        longDescription: "Fluff'n Bluff specializes in fun, colorful, and engaging pet accessories that bring joy to both pets and their owners. From interactive toys to stylish accessories, our products are designed to enhance the bond between pets and families.",
    },
    {
        name: "Nourvet",
        slug: "nourvet",
        image: "/brands/nourvet.png",
        description: "Veterinary nutrition",
        longDescription: "Nourvet provides veterinary-grade nutrition and health supplements developed by veterinarians for optimal pet health. Our therapeutic and preventive nutrition solutions address specific health concerns and support overall wellness.",
    },
    {
        name: "Jungle",
        slug: "jungle",
        image: "/brands/jungle.png",
        description: "Wild-inspired nutrition",
        longDescription: "Jungle offers wild-inspired nutrition that taps into pets' natural instincts and dietary needs. Our products feature exotic proteins and natural ingredients that provide adventurous flavors while maintaining complete nutritional balance.",
    },
];
