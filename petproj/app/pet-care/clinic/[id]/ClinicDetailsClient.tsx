...
interface ClinicDetailsClientProps {
    initialClinic: ClinicDetails;
    initialReviewStats: { averageRating: number; reviewsCount: number };
}

export default function ClinicDetailsClient({ initialClinic, initialReviewStats }: ClinicDetailsClientProps) {
    const params = useParams();
    const [clinic, setClinic] = useState<ClinicDetails>(initialClinic);
    const [reviewStats, setReviewStats] = useState<{
        averageRating: number;
        reviewsCount: number;
    } | null>(initialReviewStats);
    ...
    // Refetchers — the initial render comes from server-fetched props, these
    // are only used to refresh after a review is submitted.
