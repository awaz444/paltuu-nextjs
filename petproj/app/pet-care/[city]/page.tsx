...
export async function generateStaticParams() {
    return KNOWN_CITIES.map((city) => ({ city: city.toLowerCase() }));
}
...
export async function generateMetadata({
    ...
    return {
        ...
        openGraph: {
            title,
            description,
            url: `https://paltuu.pk/pet-care/${params.city}`,
            type: "website",
            images: [
                {
        ...
        alternates: { canonical: `https://paltuu.pk/pet-care/${params.city}` },
    };
}

export default async function CityVetsPage({
    params,
}: {
    params: { city: string };
}) {
    ...
    const jsonLdBreadcrumb = {
        ...
        itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: "Pet Care", item: "https://paltuu.pk/pet-care" },
            {
                ...
                item: `https://paltuu.pk/pet-care/${params.city}`,
            },
        ],
    };
