...
export default function HomieBrandPage() {
  const dispatch = useDispatch<AppDispatch>();
  const { products, loading, error } = useSelector((state: RootState) => state.marketplace);
  const [brandProducts, setBrandProducts] = useState<Product[]>([]);

  const brandName = "Homie";
  const displayName = "Homie Pet Food Pakistan";
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-4">
                Shop authentic <span className="font-semibold text-gray-900">Homie dry cat food</span> in Pakistan.
                We are your official source for affordable nutrition, delivering to
      ...
      <div className="bg-white border-t border-gray-200 mt-12 py-12">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">
            Why Choose Homie Pet Food?
          </h2>
          <div className="grid md:grid-cols-2 gap-8 text-gray-600">
            <div>
              <h3 className="font-bold text-gray-900 mb-2">Balanced Nutrition</h3>
              <p className="text-sm leading-relaxed">
                Homie provides a balanced diet for cats and dogs at an affordable price point.
                It's a great choice for pet owners looking for quality on a budget.
              </p>
            </div>
            <div>
              <h3 className="font-bold text-gray-900 mb-2">Homie Price in Karachi</h3>
              <p className="text-sm leading-relaxed">
                We guarantee the best rates for Homie cat food in Karachi.
                Order today and get fast delivery to your neighborhood.
              </p>
            </div>
          </div>
        </div>
