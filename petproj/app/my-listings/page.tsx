...
const ADOPTION_CHECKLIST = [
  {
    ...
    description: "Applicant has a stable home environment suitable for a pet",
  ...
  },
  {
    ...
    description: "Applicant has prior experience with pets or has done research",
    icon: <SafetyCertificateOutlined />
  },
  {
    title: "Financial Capability",
    description: "Financially capable of covering pet expenses (food, vet, etc.)",
    icon: <DollarOutlined />
  },
  {
            ...
            <div className="w-full max-w-4xl mt-6 mb-8 bg-white rounded-xl shadow-sm overflow-hidden">
              <div className="p-6 bg-gradient-to-r from-blue-50 to-indigo-50">
                ...
                <p className="text-gray-600">
                  Complete these requirements to ensure a successful adoption process
                </p>
              </div>
              ...
              <div className="p-6">
                ...
                >
                  <Panel 
                    header={<span className="font-medium text-primary">Why are these checks important?</span>} 
                    key="1"
                    className="border-0"
                  >
                    <div className="text-gray-600 text-sm pl-5">
                      <ul className="list-disc space-y-2">
                        <li>These requirements help ensure pets are placed in safe, loving, and permanent homes</li>
                        <li>They minimize the risk of pets being returned or rehomed</li>
                        <li>They help match pets with owners who can properly care for them</li>
                        <li>They ensure adopters understand the responsibilities of pet ownership</li>
                      </ul>
                    </div>
                  </Panel>
                </Collapse>
