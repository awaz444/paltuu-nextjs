...
export default function BritCareBrandPage() {
    ...
    const displayName = "Brit Care";

    useEffect(() => {
        // Fetch products with Brit Care keyword
            ...
            <div className="bg-white border-b border-gray-200">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-primary font-medium text-lg">brit-care</p>
                    </div>
                    ...
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            <p className="text-primary font-medium">Holistic pet nutrition</p>
                        </div>
                    </div>
