...
const Navbar = ({
    ...
    const totalCartItems = cartItemsNav.reduce(
                                ...
                                <div
                                    ...
                                    dropdownOverride.length ? (
                                        ...
                                        <>
                                            ...
                                            <Link href="/my-orders">
                                                <div className="dropdown-item flex items-center gap-3 px-4 py-2 hover:bg-gray-100 cursor-pointer">
                                                    <i className="bi bi-bag text-gray-600"></i>{" "}
                                                    My Orders
                                                </div>
                                            </Link>
