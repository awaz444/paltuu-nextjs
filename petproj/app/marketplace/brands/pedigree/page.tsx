...
export default function PedigreeBrandPage() {
    ...
    const displayName = "Pedigree";

    useEffect(() => {
        // Fetch products with Pedigree keyword
            ...
            <div className="bg-white border-b border-gray-200">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-primary font-medium text-lg">pedigree</p>
                    </div>
                    ...
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            <p className="text-primary font-medium">Complete nutrition for dogs</p>
                        </div>
                    </div>

                    <p className="text-gray-600 text-lg max-w-3xl">
                        Pedigree is a globally trusted brand providing complete and balanced nutrition for dogs of all ages and sizes. With decades of research and expertise, Pedigree offers scientifically formulated products that support healthy growth and development.
                    </p>
                </div>
            </div>
