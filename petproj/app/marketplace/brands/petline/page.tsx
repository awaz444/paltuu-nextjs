...
export default function PetlineBrandPage() {
  const dispatch = useDispatch<AppDispatch>();
  const { products, loading, error } = useSelector((state: RootState) => state.marketplace);
  const [brandProducts, setBrandProducts] = useState<Product[]>([]);

  const brandName = "Petline";
  const displayName = "Petline Premium Pet Food Pakistan";
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-4">
                Shop authentic <span className="font-semibold text-gray-900">Petline super premium pet food</span> in Pakistan.
                We are your official source for high-quality nutrition, delivering to
      ...
      <div className="bg-white border-t border-gray-200 mt-12 py-12">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 text-gray-600">
            <div>
              <h3 className="font-bold text-gray-900 mb-2">Super Premium Quality</h3>
              <p className="text-sm leading-relaxed">
                Petline offers super premium nutrition crafted with high-quality ingredients.
                It's designed to provide superior taste and digestibility for your pets.
              </p>
            </div>
            <div>
              <h3 className="font-bold text-gray-900 mb-2">Petline Price in Karachi</h3>
              <p className="text-sm leading-relaxed">
                We offer competitive pricing for Petline products in Karachi.
                Order online for fresh stock delivered straight to your door.
              </p>
            </div>
          </div>
        </div>
