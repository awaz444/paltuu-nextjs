...
export default function WhiskasBrandPage() {
    const dispatch = useDispatch<AppDispatch>();
    const { products, loading, error } = useSelector((state: RootState) => state.marketplace);
    const [brandProducts, setBrandProducts] = useState<Product[]>([]);

    const brandName = "Whiskas";
    const displayName = "Whiskas Cat Food Pakistan";
                    ...
                    <div className="flex flex-col md:flex-row gap-8 items-start">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-4">
                                Shop authentic <span className="font-semibold text-gray-900">Whiskas cat food</span> in Pakistan.
                                We are your official source for tasty nutrition for kittens and adult cats, delivering to
                        ...
                        <div className="mb-8 flex justify-between items-end border-b border-gray-200 pb-4">
                            <div>
                                ...
                                <p className="text-gray-500 text-sm mt-1">
                                    Browsing {brandProducts.length} tasty nutrition items
                                </p>
                            </div>
                        </div>
            ...
            <div className="bg-white border-t border-gray-200 mt-12 py-12">
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 text-gray-600">
                        <div>
                            <h3 className="font-bold text-gray-900 mb-2">Tasty Nutrition</h3>
                            <p className="text-sm leading-relaxed">
                                Whiskas is loved by cats for its great taste and variety.
                                It provides complete nutrition for kittens and adults.
                            </p>
                        </div>
                        <div>
                            <h3 className="font-bold text-gray-900 mb-2">Whiskas Price in Karachi</h3>
                            <p className="text-sm leading-relaxed">
                                Get the best value for Whiskas pouches and dry food in Karachi.
                                We offer bulk deals and fast delivery.
                            </p>
                        </div>
                    </div>
                </div>
