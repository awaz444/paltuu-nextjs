...
export default function JungleBrandPage() {
    const dispatch = useDispatch<AppDispatch>();
    const { products, loading, error } = useSelector((state: RootState) => state.marketplace);
    const [brandProducts, setBrandProducts] = useState<Product[]>([]);

    const brandName = "Jungle";
    const displayName = "Jungle Pet Food Pakistan";
                    ...
                    <div className="flex flex-col md:flex-row gap-8 items-start">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-4">
                                Shop authentic <span className="font-semibold text-gray-900">Jungle premium pet food</span> in Pakistan.
                                We are your official source for cat and dog food, delivering to
                        ...
                        <div className="mb-8 flex justify-between items-end border-b border-gray-200 pb-4">
                            <div>
                                ...
                                <p className="text-gray-500 text-sm mt-1">
                                    Browsing {brandProducts.length} pet food items
                                </p>
                            </div>
                        </div>
            ...
            <div className="bg-white border-t border-gray-200 mt-12 py-12">
                <div className="max-w-4xl mx-auto px-4">
                    <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">
                        Why Choose Jungle Pet Food?
                    </h2>
                    <div className="grid md:grid-cols-2 gap-8 text-gray-600">
                        <div>
                            <h3 className="font-bold text-gray-900 mb-2">Premium Ingredients</h3>
                            <p className="text-sm leading-relaxed">
                                Jungle pet food offers high-quality nutrition to support your pet's active lifestyle.
                                Enriched with vitamins and minerals for optimal health.
                            </p>
                        </div>
                        <div>
                            <h3 className="font-bold text-gray-900 mb-2">Jungle Price in Karachi</h3>
                            <p className="text-sm leading-relaxed">
                                We offer competitive pricing on all Jungle products.
                                Shop online and get reliable delivery across Karachi.
                            </p>
                        </div>
                    </div>
                </div>
