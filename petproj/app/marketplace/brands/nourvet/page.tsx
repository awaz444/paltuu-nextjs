...
export default function NourvetBrandPage() {
    ...
    const displayName = "Nourvet";

    useEffect(() => {
        // Fetch products with Nourvet keyword
            ...
            <div className="bg-white border-b border-gray-200">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-primary font-medium text-lg">nourvet</p>
                    </div>
                    ...
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            <p className="text-primary font-medium">Veterinary nutrition</p>
                        </div>
                    </div>

                    <p className="text-gray-600 text-lg max-w-3xl">
                        Nourvet provides veterinary-grade nutrition and supplements designed to support optimal pet health. Our scientifically formulated products include therapeutic diets, nutritional supplements, vitamins, and specialized health solutions developed in collaboration with veterinary professionals.
                    </p>
                </div>
            </div>
