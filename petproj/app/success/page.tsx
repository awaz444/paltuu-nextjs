    ...
    return (
        <>
            <Head>
                ...
                <meta
                    name="description"
                    content="Exclusive access for early supporters"
                />
            </Head>
            ...
            <div className="min-h-screen bg-gradient-to-br from-[#faf5f6] to-[#f0e4e8] flex flex-col items-center justify-center p-4 relative overflow-hidden">
                <div className="max-w-2xl w-full bg-white rounded-3xl shadow-lg overflow-hidden z-10">
                    ...
                    <div
                        ...
                        style={{
                            background: `linear-gradient(135deg, ${primaryColor} 0%, #7a1c3a 100%)`,
                        }}>
                    ...
                    <div className="p-8 md:p-10 space-y-6">
                        <div className="space-y-4">
                            <div className="flex items-start gap-4">
                                <CheckCircleIcon className="h-6 w-6 text-[--color-primary] mt-1 flex-shrink-0" />
                                <div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">
                                        Early invites to beta programs, events,
                                        and founder-only rewards.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 pt-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">
                                        Keep an eye on your inbox for exciting
                                        updates.
                                        <br />
                        ...
                        <div className="text-center space-y-4">
                            ...
                            <div className="flex justify-center items-center space-x-4">
                                <a
                                    href="https://instagram.com/paltuupk"
                                    className="p-2 rounded-full bg-gray-100 hover:bg-gray-200 transition">
                                    <InstagramIcon />
                                </a>
                                <a
                                    href="https://www.tiktok.com/@paltuupk"
                                    className="p-2 rounded-full bg-gray-100 hover:bg-gray-200 transition">
                                    <TikTokIcon />
                                </a>
                                <a
                                    href="https://www.linkedin.com/company/paltuu"
                                    className="p-2 rounded-full bg-gray-100 hover:bg-gray-200 transition">
                                    <LinkedInIcon />
                                </a>
                            </div>
                            <p className="text-[--color-primary] text-sm mt-2">
                                Tag us and share the love using{" "}
                                <strong>#FoundersWithPaws</strong>
                            </p>
                        </div>
                    </div>
                </div>
