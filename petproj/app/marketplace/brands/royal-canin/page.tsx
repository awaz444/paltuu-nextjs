                    ...
                    <div className="flex flex-col md:flex-row gap-8 items-start">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-4">
                                Shop authentic <span className="font-semibold text-gray-900">Royal Canin veterinary diet</span> in Pakistan.
                                We are your official source for breed-specific nutrition, delivering to
                        ...
                        <div className="mb-8 flex justify-between items-end border-b border-gray-200 pb-4">
                            <div>
                                ...
                                <p className="text-gray-500 text-sm mt-1">
                                    Browsing {brandProducts.length} precise nutrition items
                                </p>
                            </div>
                        </div>
            ...
            <div className="bg-white border-t border-gray-200 mt-12 py-12">
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 text-gray-600">
                        <div>
                            <h3 className="font-bold text-gray-900 mb-2">Scientific Nutrition</h3>
                            <p className="text-sm leading-relaxed">
                                Royal Canin offers precise nutrition for your pet's specific needs.
                                Whether it's breed, age, or health condition, there's a formula for it.
                            </p>
                        </div>
                        <div>
                            <h3 className="font-bold text-gray-900 mb-2">Royal Canin Price in Karachi</h3>
                            <p className="text-sm leading-relaxed">
                                Find the best prices for Royal Canin dry and wet food in Karachi.
                                We stock a wide range of veterinary diets and retail products.
                            </p>
                        </div>
                    </div>
                </div>
