                ...
                return (
                    <div
                        ...
                        <div className="h-full flex flex-col bg-white p-4 rounded-2xl shadow-sm border-2 border-transparent relative overflow-hidden">
                            ...
                            {/* Fee Badge */}
                            {/* <div className="mt-2 pt-2 bg-gray-100 text-sm text-primary font-bold py-1 px-3 rounded-lg w-fit">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between bg-gray-50 p-3 rounded-lg">
                            ...
                            <Button
                                ...
                                size="small"
                                onClick={() =>
                                    handleCopy(selectedVet.contact_details)
                                }
                        ...
                        <button
                            className="w-full bg-green-500 hover:bg-green-600 text-white h-12 rounded-lg flex items-center justify-center space-x-2"
                            onClick={() =>
                                handleWhatsApp(selectedVet.contact_details)
                            }>
                            <WhatsAppOutlined />
