...
// ring, which is 10am-10pm Pakistan time (a 12-hour window: 10:00 up to, but not including,
// 22:00). Outside that window nobody gets pinged for a new request, regardless of mute
