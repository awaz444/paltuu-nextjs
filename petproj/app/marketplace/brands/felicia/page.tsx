...
export default function FeliciaBrandPage() {
  const dispatch = useDispatch<AppDispatch>();
  const { products, loading, error } = useSelector((state: RootState) => state.marketplace);
  const [brandProducts, setBrandProducts] = useState<Product[]>([]);

  const brandName = "Felicia";
  const displayName = "Felicia Pakistan";
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-4">
                Shop authentic <span className="font-semibold text-gray-900">Felicia low-grain pet food</span> in Pakistan.
      ...
      <div className="bg-white border-t border-gray-200 mt-12 py-12">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">
            Why Choose Felicia for Your Pet?
          </h2>
          <div className="grid md:grid-cols-2 gap-8 text-gray-600">
            <div>
              <h3 className="font-bold text-gray-900 mb-2">Low-Grain Nutrition</h3>
              <p className="text-sm leading-relaxed">
                Felicia is renowned for its low-grain and hypoallergenic formulas.
                Designed to be gentle on sensitive stomachs, it provides complete nutrition without common allergens.
              </p>
            </div>
            <div>
              <h3 className="font-bold text-gray-900 mb-2">Felicia Price in Karachi</h3>
              <p className="text-sm leading-relaxed">
                Get the best rates for Felicia dry food in Karachi.
                We stock all formulations including Kitten, Adult Cat, and Sterilized options.
              </p>
            </div>
          </div>
        </div>
